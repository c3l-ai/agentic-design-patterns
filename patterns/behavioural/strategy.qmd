...
The working conceptual diagram (@fig-strategy-conceptual) annotates each node with its runtime properties: strategy selection as metacognitive appraisal, the Factory Method tension, context handoff on mid-execution substitution, and the dual eval layer.

![Strategy pattern — annotated runtime diagram. Strategy selection as metacognitive appraisal, Factory Method tension, context handoff requirements, and eval layer covering both selection appropriateness and output quality.](figures/strategy-conceptual.svg){#fig-strategy-conceptual}
