...
The working conceptual diagram (@fig-singleton-conceptual) annotates each singleton with its update frequency, access pattern, failure mode, versioning requirement, and responsible AI implications.

![Singleton pattern — annotated runtime diagram. Update frequency, versioned access pattern, safety-critical failure mode for SafetyConstraintStore, and concurrent write coordination for active data products annotated throughout.](figures/singleton-conceptual.svg){#fig-singleton-conceptual}
